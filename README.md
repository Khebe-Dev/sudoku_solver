...
```
cd existing_repo
git remote add origin https://gitlab.wethinkco.de/khhebecpt024/sudoku_solver.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.wethinkco.de/khhebecpt024/sudoku_solver/-/settings/integrations)
